...
* Translates Oracle integer-indexed associative array type to C# List<T> of the value type
* Configurable translation of Oracle REF CURSROR result set to C# IList<T>, ICollection<T>, or List<T>
...
namespace Schema.Odpt.Xmpl.Package {
    ...
    public sealed partial class XmplPkgExample : Schema.Odpt.Xmpl.OdptAdapter {
        ...
        public IList<T_TTableBigPartial> GetRowsTypedRet<T_TTableBigPartial>(Decimal? pInNumber, ref String pInOutVarchar2, ref List<Int64?> pInOutAssocarrayInteger, out DateTime? pOutDate, 
