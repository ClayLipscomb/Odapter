//------------------------------------------------------------------------------
// <auto-generated>
//     This code was auto-generated by Odapter on Fri, 05 Oct 2018 02:05:11 GMT.
        ...
        public String FuncClob(String pIn, ref String pInOut, out String pOut, OracleConnection optionalPreexistingOpenConnection = null) {
            ...
            try {
                using (OracleCommand __cmd = new OracleCommand("ODPT.ODPT_PKG_MAIN.FUNC_CLOB", __conn)) {
                    __cmd.CommandType = CommandType.StoredProcedure;
                    __cmd.BindByName = true;
                    __cmd.Parameters.Add(new OracleParameter("!RETURN", OracleDbType.Clob, 32767, null, ParameterDirection.ReturnValue));
                    __cmd.Parameters.Add(new OracleParameter("P_IN", OracleDbType.Clob, pIn, ParameterDirection.Input));
                    __cmd.Parameters.Add(new OracleParameter("P_IN_OUT", OracleDbType.Clob, 32767, pInOut, ParameterDirection.InputOutput));
                    __cmd.Parameters.Add(new OracleParameter("P_OUT", OracleDbType.Clob, 32767, null, ParameterDirection.Output));
        ...
        public String FuncNclob(String pIn, ref String pInOut, out String pOut, OracleConnection optionalPreexistingOpenConnection = null) {
            ...
            try {
                using (OracleCommand __cmd = new OracleCommand("ODPT.ODPT_PKG_MAIN.FUNC_NCLOB", __conn)) {
                    __cmd.CommandType = CommandType.StoredProcedure;
                    __cmd.BindByName = true;
                    __cmd.Parameters.Add(new OracleParameter("!RETURN", OracleDbType.NClob, 32767, null, ParameterDirection.ReturnValue));
                    __cmd.Parameters.Add(new OracleParameter("P_IN", OracleDbType.NClob, pIn, ParameterDirection.Input));
                    __cmd.Parameters.Add(new OracleParameter("P_IN_OUT", OracleDbType.NClob, 32767, pInOut, ParameterDirection.InputOutput));
                    __cmd.Parameters.Add(new OracleParameter("P_OUT", OracleDbType.NClob, 32767, null, ParameterDirection.Output));
