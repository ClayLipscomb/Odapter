...
namespace Schema.Odpt.Odpt.Safe.Type.Object {
    ...
    // public partial class OdptAnydataOt : Schema.Odpt.Odpt.Safe.OdptObjectType {

    [DataContract(Namespace="http://odpt.business.com")][Serializable()]
    public abstract partial class OdptBaseScTransTypeOt : Schema.Odpt.Odpt.Safe.OdptObjectType {
        ...
        public virtual OracleClob FlexibleColumn17 { get; set; }
        [DataMember(Order=18, IsRequired=false)][XmlElement(Order=18, IsNullable=true)]
        public virtual OracleDate? FlexibleColumn18 { get; set; }
        [DataMember(Order=19, IsRequired=false)][XmlElement(Order=19, IsNullable=true)]
        public virtual OracleDate? FlexibleColumn19 { get; set; }
        [DataMember(Order=20, IsRequired=false)][XmlElement(Order=20, IsNullable=true)]
        public virtual OracleTimeStamp? FlexibleColumn20 { get; set; }
        [DataMember(Order=21, IsRequired=false)][XmlElement(Order=21, IsNullable=true)]
        public virtual OracleDecimal? FlexibleColumn21 { get; set; }
        [DataMember(Order=22, IsRequired=false)][XmlElement(Order=22, IsNullable=true)]
        public virtual OracleDecimal? FlexibleColumn22 { get; set; }
        [DataMember(Order=23, IsRequired=false)][XmlElement(Order=23, IsNullable=true)]
        public virtual OracleDecimal? FlexibleColumn23 { get; set; }
        [DataMember(Order=24, IsRequired=false)][XmlElement(Order=24, IsNullable=true)]
        public virtual OracleDecimal? FlexibleColumn24 { get; set; }
        [DataMember(Order=25, IsRequired=false)][XmlElement(Order=25, IsNullable=true)]
        public virtual OracleDecimal? FlexibleColumn25 { get; set; }
    } // OdptBaseScTransTypeOt

    [DataContract(Namespace="http://odpt.business.com")][Serializable()]
    public partial class OdptBigOt : Schema.Odpt.Odpt.Safe.OdptObjectType {
        private Byte propertyToEnsuresPartialClassNamesAreUniqueAtCompileTime { get; set; }
        [DataMember(Order=1, IsRequired=false)][XmlElement(Order=1, IsNullable=true)]
        public virtual OracleDecimal? Id { get; set; }
        [DataMember(Order=2, IsRequired=false)][XmlElement(Order=2, IsNullable=true)]
        public virtual OracleDecimal? AttrNumberId { get; set; }
        [DataMember(Order=3, IsRequired=false)][XmlElement(Order=3, IsNullable=true)]
        public virtual OracleDecimal? AttrInteger { get; set; }
        [DataMember(Order=4, IsRequired=false)][XmlElement(Order=4, IsNullable=true)]
        public virtual OracleDecimal? AttrInt { get; set; }
        [DataMember(Order=5, IsRequired=false)][XmlElement(Order=5, IsNullable=true)]
        public virtual OracleDecimal? AttrSmallint { get; set; }
        [DataMember(Order=6, IsRequired=false)][XmlElement(Order=6, IsNullable=true)]
        public virtual OracleDecimal? AttrNumber { get; set; }
        [DataMember(Order=7, IsRequired=false)][XmlElement(Order=7, IsNullable=true)]
        public virtual OracleDecimal? AttrNumeric { get; set; }
        [DataMember(Order=8, IsRequired=false)][XmlElement(Order=8, IsNullable=true)]
        public virtual Decimal? AttrNumeric31Scale21 { get; set; }
        [DataMember(Order=9, IsRequired=false)][XmlElement(Order=9, IsNullable=true)]
        public virtual OracleDecimal? AttrDecimal { get; set; }
        [DataMember(Order=10, IsRequired=false)][XmlElement(Order=10, IsNullable=true)]
        public virtual Decimal? AttrDecima38Scale37 { get; set; }
        [DataMember(Order=11, IsRequired=false)][XmlElement(Order=11, IsNullable=true)]
        public virtual OracleDecimal? AttrFloat { get; set; }
        [DataMember(Order=12, IsRequired=false)][XmlElement(Order=12, IsNullable=true)]
        public virtual OracleDecimal? AttrReal { get; set; }
        [DataMember(Order=13, IsRequired=false)][XmlElement(Order=13, IsNullable=true)]
        public virtual OracleDecimal? AttrDoublePrecision { get; set; }
        [DataMember(Order=14, IsRequired=false)][XmlElement(Order=14, IsNullable=true)]
    ...
    public partial class OdptPoVendorOt : OdptScTtTblUniqueOt {
        private Byte propertyToEnsuresPartialClassNamesAreUniqueAtCompileTime { get; set; }
        [DataMember(Order=26, IsRequired=false)][XmlElement(Order=26, IsNullable=true)]
        public virtual OracleDecimal? VendorId { get; set; }
        [DataMember(Order=27, IsRequired=false)][XmlElement(Order=27, IsNullable=true)]
        public virtual OracleDate? LastUpdateDate { get; set; }
        [DataMember(Order=28, IsRequired=false)][XmlElement(Order=28, IsNullable=true)]
        public virtual OracleDecimal? LastUpdatedBy { get; set; }
        [DataMember(Order=29, IsRequired=false)][XmlElement(Order=29, IsNullable=true)]
        ...
        public virtual OracleDecimal? TermsId { get; set; }
        [DataMember(Order=53, IsRequired=false)][XmlElement(Order=53, IsNullable=true)]
        public virtual OracleDecimal? SetOfBooksId { get; set; }
        ...
        public virtual OracleDecimal? CreditLimit { get; set; }
        ...
        public virtual OracleDecimal? PaymentPriority { get; set; }
        ...
        public virtual OracleDecimal? InvoiceAmountLimit { get; set; }
        ...
        public virtual OracleDecimal? DistributionSetId { get; set; }
        [DataMember(Order=68, IsRequired=false)][XmlElement(Order=68, IsNullable=true)]
        public virtual OracleDecimal? AcctsPayCodeCombinationId { get; set; }
        [DataMember(Order=69, IsRequired=false)][XmlElement(Order=69, IsNullable=true)]
        public virtual OracleDecimal? DiscLostCodeCombinationId { get; set; }
        [DataMember(Order=70, IsRequired=false)][XmlElement(Order=70, IsNullable=true)]
        public virtual OracleDecimal? DiscTakenCodeCombinationId { get; set; }
        [DataMember(Order=71, IsRequired=false)][XmlElement(Order=71, IsNullable=true)]
        public virtual OracleDecimal? ExpenseCodeCombinationId { get; set; }
        [DataMember(Order=72, IsRequired=false)][XmlElement(Order=72, IsNullable=true)]
        public virtual OracleDecimal? PrepayCodeCombinationId { get; set; }
        ...
        public virtual OracleDate? WithholdingStartDate { get; set; }
        ...
        public virtual OracleDate? StartDateActive { get; set; }
        [DataMember(Order=80, IsRequired=false)][XmlElement(Order=80, IsNullable=true)]
        public virtual OracleDate? EndDateActive { get; set; }
        [DataMember(Order=81, IsRequired=false)][XmlElement(Order=81, IsNullable=true)]
        public virtual OracleDecimal? QtyRcvTolerance { get; set; }
        ...
        public virtual OracleDecimal? HoldBy { get; set; }
        [DataMember(Order=101, IsRequired=false)][XmlElement(Order=101, IsNullable=true)]
        public virtual OracleDate? HoldDate { get; set; }
        ...
        public virtual OracleDecimal? PriceTolerance { get; set; }
        ...
        public virtual OracleDecimal? DaysEarlyReceiptAllowed { get; set; }
        [DataMember(Order=109, IsRequired=false)][XmlElement(Order=109, IsNullable=true)]
        public virtual OracleDecimal? DaysLateReceiptAllowed { get; set; }
        ...
        public virtual OracleDecimal? ReceivingRoutingId { get; set; }
        ...
        public virtual OracleDate? TaxVerificationDate { get; set; }
        ...
        public virtual OracleDecimal? AwtGroupId { get; set; }
        ...
        public virtual OracleDecimal? FutureDatedPaymentCcid { get; set; }
        ...
        public virtual OracleDecimal? UniqueTaxReferenceNum { get; set; }
        [DataMember(Order=181, IsRequired=false)][XmlElement(Order=181, IsNullable=true)]
        public virtual OracleDecimal? PartnershipUtr { get; set; }
        ...
        public virtual OracleDecimal? VerificationRequestId { get; set; }
        ...
        public virtual OracleDate? CisVerificationDate { get; set; }
        ...
        public virtual OracleDecimal? CisParentVendorId { get; set; }
        [DataMember(Order=198, IsRequired=false)][XmlElement(Order=198, IsNullable=true)]
        public virtual OracleDate? BusClassLastCertifiedDate { get; set; }
        [DataMember(Order=199, IsRequired=false)][XmlElement(Order=199, IsNullable=true)]
        public virtual OracleDecimal? BusClassLastCertifiedBy { get; set; }
    } // OdptPoVendorOt
    ...
    // public partial class OdptXmltypeOt : Schema.Odpt.Odpt.Safe.OdptObjectType {
