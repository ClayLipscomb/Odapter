CREATE OR REPLACE PACKAGE ODPT.fltr_pkg_rec_unused AS

	-- untyped cursor type
	TYPE t_ref_cursor IS REF CURSOR;

	-- typed cursor type
	TYPE t_table_big_flt_unused IS RECORD
	...
	TYPE t_ref_cursor_table_big IS REF CURSOR RETURN t_table_big_flt_unused;

END fltr_pkg_rec_unused;
/