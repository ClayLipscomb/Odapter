...
namespace Schema.Odpt.Package {
    ...
    public partial class OdptPkgMain : Schema.Odpt.OdptAdapter {
        ...
        // public SByte[] FuncBfile(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
        ...
        // public SByte[] FuncBlob(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
        ...
        // public SByte[] FuncClob(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
        ...
        // public SByte[] FuncLong(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)

        // **PROC IGNORED** - Code generation for LONG RAW will not be implemented due to Oracle deprecation 
        // public SByte[] FuncLongRaw(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
        ...
        // public SByte[] FuncNclob(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
        ...
        // public SByte[] FuncRaw(SByte[] pIn, ref SByte[] pInOut, out SByte[] pOut, OracleConnection optionalPreexistingOpenConnection = null)
    ...
    public partial class OdptPkgTableBig : Schema.Odpt.OdptAdapter {
        ...
        [DataContract(Namespace="http://odpt.business.com")][Serializable()]
        public partial class FilteredPkgTTableBigFiltered : Schema.Odpt.OdptPackageRecord, IFilteredPkgTTableBigFiltered {
            private Byte propertyToEnsuresPartialClassNamesAreUniqueAtCompileTime { get; set; }
            [DataMember(Order=0, IsRequired=false)][XmlElement(Order=0, IsNullable=true)]
            public virtual Int64? Id { get; set; }
            [DataMember(Order=1, IsRequired=false)][XmlElement(Order=1, IsNullable=true)]
        ...
        public List<T_FilteredPkgTTableBigFiltered> GetRowsTypedFilteredPkg<T_FilteredPkgTTableBigFiltered>(out List<T_FilteredPkgTTableBigFiltered> pRefCursor, out List<T_FilteredPkgTTableBigFiltered> pRefCursor2, UInt32? optionalMaxNumberRowsToReadFromAnyCursor = null, OracleConnection optionalPreexistingOpenConnection = null)
                where T_FilteredPkgTTableBigFiltered : class, IFilteredPkgTTableBigFiltered, new() {
            List<T_FilteredPkgTTableBigFiltered> __ret = new List<T_FilteredPkgTTableBigFiltered>(); pRefCursor = new List<T_FilteredPkgTTableBigFiltered>(); pRefCursor2 = new List<T_FilteredPkgTTableBigFiltered>(); 
            OracleConnection __conn = optionalPreexistingOpenConnection ?? GetConnection();
            try {
        ...
        public DataTable GetRowsUntypedFilteredPkg(out DataTable pRefCursor, out DataTable pRefCursor2, Boolean convertColumnNameToTitleCaseInCaption = false, UInt32? optionalMaxNumberRowsToReadFromAnyCursor = null, 
                OracleConnection optionalPreexistingOpenConnection = null) {
        ...
        public Int64? InsertRow(Int64? pColNumberId, Int64? pColInteger, Int64? pColInt, Int64? pColSmallint, 
                ...
                DateTime? pColTimestampPrec9, OracleConnection optionalPreexistingOpenConnection = null) {
            Int64? __ret = null; 
            OracleConnection __conn = optionalPreexistingOpenConnection ?? GetConnection();
            try {
